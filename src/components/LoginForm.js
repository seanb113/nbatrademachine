...
class LoginForm extends React.Component {
    state = {
      ...
      handleLoginSubmit = (e) => {
        e.preventDefault()
        fetch('https://nbatrademachine-app-api.herokuapp.com/login', {
...
render(){
        ...
        return(
            <div>
            <div className="ui form container" style={{color: "#201D3A"}}>
        <form className="ui form" onSubmit={this.handleLoginSubmit} style={{color: "#201D3A"}}>
