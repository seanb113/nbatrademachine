        ...
        return obj
            ...
            return(
              ...
              <Dropdown
                ...
                <div id="sortGrid">
                <button id="sortButton" class="small ui button" onClick={()=>this.handleSort('hot')}>Hot</button>
                <button id="sortButton" class="small ui button" onClick={()=>this.handleSort('new')}>New</button>
                </div>
                </div>
            <div id="tradeLists" className="ui cards">
        {groupToPlayers.map((t, i) => Object.keys(t).length === 2 ?
