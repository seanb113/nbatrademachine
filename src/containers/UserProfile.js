...
const UserProfile  = props => {
    let madeAnyTrades = () => {
        ...
        return <div class="ui third centered header" style={{color: "#201D3A"}}>Your trades:</div>
        else
        return <div class="ui third centered header" style={{color: "#201D3A"}}>You haven't made any trades. Click <Link to="/machine">here</Link> to go to the trade machine.</div>
    }
        return(
            <div>
            <br></br>
